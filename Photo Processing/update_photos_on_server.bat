...
copy "T:\PROJECTS\AKR\FMSS\PHOTOS\PROCESSING\website scripts\buildings.csv" \\akrgis.nps.gov\inetApps\buildings\data\buildings.csv
copy "T:\PROJECTS\AKR\FMSS\PHOTOS\PROCESSING\website scripts\photos.json" \\akrgis.nps.gov\inetApps\fmss\photos.json
:EOF
